...
define( 'COLUMNS_LAYOUT_CLASSES', 'col-md-6 col-lg-4' );
...
if ( function_exists( 'wpmem_init' ) ) {
    $understrap_includes[] = '/smn-members.php';
}

if ( class_exists('DLM_File_Manager') ) {
    $understrap_includes[] = '/smn-download-monitor.php';
}
...
function smn_admin_style() {
    wp_enqueue_style('smn-admin-styles', get_stylesheet_directory_uri().'/css/admin.css');
}
