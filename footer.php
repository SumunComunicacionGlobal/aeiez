...
<?php if ( is_active_sidebar( 'after-footerfull' ) ) { ?>
	
	<div class="wrapper" id="wrapper-after-footerfull">

		<div class="container">
			
			<?php dynamic_sidebar( 'after-footerfull' ); ?>
...
<div class="wrapper" id="wrapper-footer">
	...
	<div class="<?php echo esc_attr( $container ); ?>">
		...
		<?php dynamic_sidebar( 'legal-text' ); ?>
