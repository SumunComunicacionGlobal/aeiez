...
if ( function_exists( 'register_block_style' ) ) {
    ...
    register_block_style(
        ...
        array(
            'name'         => 'image-mask',
            'label'        => __( 'Máscara en imagen', 'smn-admin' ),
            'is_default'   => false,
        )
    );
    ...
    foreach( $display_text_block_types as $block_type ) {
        ...
        register_block_style(
            ...
            array(
                'name'         => 'red-triangle',
                'label'        => __( 'Triángulo rojo', 'smn-admin' ),
                'is_default'   => false,
            )
        );
...
add_filter( 'render_block', 'image_header_breadcrumb', 10, 2 );
function image_header_breadcrumb( $block_content, $block ) {
